...
const Signup = () => {
  ...
  const handleSubmit = async (e:FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.put(`${import.meta.env.VITE_API_URI}/api/users/signup`,formData)
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="action space-y-3 mt-5">
              <button
                ...
                className="w-full p-2 disabled:bg-blue-300    bg-primary hover:bg-blue-600 text-white rounded shadow"
              >
                {isSubmitting ? (
                  <span className="inline-flex items-center w-full justify-center">
                    <svg
                      aria-hidden="true"
